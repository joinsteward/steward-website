...
const CustomRadio = ({ value, setValue, className, data, type, name, hasError }) => {
      ...
      {data.map((item, index) => (
        <div
          className={classNames(
            'w-fit cursor-pointer rounded-lg border border-gray-200 bg-white p-4 text-gray-500 transition-colors ease-in-out hover:border-gray-900 active:border-gray-900 active:outline-none active:ring-4 active:ring-gray-400 active:ring-opacity-30',
            {
