  ...
  return (
    <section className="bg-white">
      <div className="container mx-auto flex flex-wrap items-center px-6 pt-12 pb-16 sm:px-0 md:pb-32  md:pt-36  lg:px-16 xl:px-5">
        <div className="pr-0 md:w-1/2 md:pl-8 lg:w-3/6 2xl:pl-16">
          <h1 className="font-duplicate-san text-4xl font-medium text-gray-900 md:text-5xl xl:text-7xl">
            We are the growth partner for private schools across Africa
          </h1>
        </div>
        <div className="mt-10 flex w-full flex-col rounded-lg  md:ml-auto md:mt-0 md:w-1/2 lg:w-3/6">
          <Image
