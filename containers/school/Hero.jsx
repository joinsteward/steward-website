...
const Hero = () => {
  return (
    <section className="gradient__bg">
      <div className="container mx-auto flex flex-col items-center px-6  pt-36 pb-16 sm:px-0 lg:px-16 xl:px-5">
        ...
        <div className="relative mt-36 w-full">
          <div className="absolute inset-0 flex flex-col items-center justify-center  text-center">
            <div className=" flex max-w-5xl flex-col items-center space-y-6 md:pt-36">
              <WhiteLogo />
              <h1 className="custom-font font-duplicate-san text-3xl font-bold text-white md:text-5xl">
